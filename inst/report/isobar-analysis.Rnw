...
cmbn.class <- t(unique(quant.tbl[,c("class1","class2")]))
...
cat("\\secsubtitle{Number of significant proteins: ",paste(sprintf("%s/%s: %s",n.quant$class2,n.quant$class1,n.quant$V1),collapse="; "),"}\n" )
...
cat("\\secsubtitle{Number of quantified proteins: ",paste(sprintf("%s/%s: %s",n.quant$class2,n.quant$class1,n.quant$V1),collapse="; "),"}")
...
n.quant <- ddply(quant.tbl,c("class1","class2"),function(x) sum(is.na(x$lratio)))
cat("\\secsubtitle{Number of identified but not quantified proteins: ",paste(sprintf("%s/%s: %s",n.quant$class2,n.quant$class1,n.quant$V1),collapse="; "),"}")
cat("\\small")
