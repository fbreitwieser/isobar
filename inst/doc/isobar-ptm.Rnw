...
Reports will be generated calling \texttt{path\_to\_isobar/report/create\_reports.R --peptide} from the directory containing the peaklists, identifications and \texttt{properties.R}.
